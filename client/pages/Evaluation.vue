                                    ...
                                    <div align-center justify-center class="gg elevation-12">
                                        ...
                                        <div class="box-select">
                                            <div align="center">
                                                <v-container fluid>
                                                    <v-col>
                                                        <h3 class="tbtitle" align="center" justify="space-around">
                                                            แบบประเมินความพึงพอใจ
                                                        </h3>
                                                        <br />
                                                        <v-select v-model="divTagIndex" :items="divisionLists" item-text="divName" item-value="divTag" label="เลือกแผนกที่ต้องการประเมิน" outlined color="gold" background-color="#F8F5FD">
                                                        </v-select>
                                                        <v-btn rounded block x-large class="btn_st_color" elevation="8" color="#881518" @click.prevent="startQuiz()">เริ่มทำการประเมิน<v-icon small>mdi-arrow-right-circle</v-icon>
                                                        </v-btn>
                                                    </v-col>
                                                </v-container>
                                            </div>
                                                                ...
                                                                <v-card-text align="center">
                                                                    <div v-for="( question, index ) in specificQuestion" :key="index">
                                                                        <div v-show="index === questionIndex">
                                                                            <template>
                                                                                <v-progress-linear color="primary" height="13" :value="(question.qSequence / specificQuestion.length) * 100">
                                                                                </v-progress-linear>
                                                                                <v-card-text align="center">
                                                                                    {{ question.qSequence }} /
                                                                                    {{ specificQuestion.length }}
                                                                                </v-card-text>
                                                                            </template>
                                                                            <h2>
                                                                                <v-icon large color="#bc8e5d">mdi-numeric-{{ question.qSequence }}-circle </v-icon>{{ question.qName }}
                                                                            </h2>
                                                                            <br />
                                                                            <v-card-text>
                                                                                <v-row>
                                                                                    <v-col cols="12" sm="6" md="6" lg="6" align="center" justify="center">
                                                                                        <v-card v-on:click="updateScore(questionIndex, 1)" color="#FFB74D" class="box_sl worst">
                                                                                            <v-card-text>
                                                                                                <br />
                                                                                    ...
                                                                                    <v-col cols="12" sm="6" md="6" lg="6" align="center" justify="center">
                                                                                        <v-card v-on:click="updateScore(questionIndex, 2)" color="#FFD740" class="box_sl moderate">
                                                                                            <v-card-text>
                                                                                                <br />
                                                                                    ...
                                                                                    <v-col cols="12" sm="6" md="6" lg="6" align="center" justify="center">
                                                                                        <v-card v-on:click="updateScore(questionIndex, 3)" color="#B2FF59" class="box_sl good">
                                                                                            <v-card-text>
                                                                                                <br />
                                                                                    ...
                                                                                    <v-col cols="12" sm="6" md="6" lg="6" align="center" justify="center">
                                                                                        <v-card v-on:click="updateScore(questionIndex, 4)" color="#84FFFF" class="box_sl best">
                                                                                            <v-card-text>
                                                                                                <br />
                                                                    ...
                                                                    <div v-show="questionIndex == specificQuestion.length">
                                                                        ...
                                                                        <br />
                                                                        <template>
                                                                            <v-textarea v-model="evalResult.comment" solo name="input-7-4" label="ช่วยให้หน่วยงานของเราให้บริการได้ดีขึ้น ด้วยการให้ข้อเสนอแนะที่นี่ :)"></v-textarea>
                                                                        </template>
                                                                    </div>
                                                                </v-card-text>
                                                            </v-container>
                                            ...
                                            <v-row>
                                                <v-col cols="6" sm="6" md="6">
                                                    <div class="addressmfu_left">
                                                        <v-icon large color="#bc8e5d" v-if="questionIndex > 0" v-on:click="prev()" class="ma-2 btn-prev">
                                                            mdi-chevron-left
                                                        </v-icon>
                                                    </div>
                                                </v-col>
                                                <v-col cols="6" sm="6" md="6">
                                                    <div class="addressmfu">
                                                        <v-icon v-if="questionIndex < specificQuestion.length" large color="#bc8e5d" v-on:click="next()" class="ma-2">
                                                            mdi-chevron-right
                                                        </v-icon>
                                                    </div>
                                                    <div class="addressmfu">
                ...
                <v-dialog v-model="dialog" max-width="500" persistent>
                    <v-card align="center" justify="center">
                        <v-card-text>
                            ...
                            <v-card-title class="text-h5 justify-center">ขอบคุณสำหรับการประเมินของคุณ<v-icon class="ml-2" medium color="green darken-1">mdi-checkbox-marked</v-icon>
                            </v-card-title>
                    ...
                    <v-card>
                        <v-card-text>
                            ...
                            <v-card-title class="text-h5 justify-center">
                                โปรดให้คะแนนความพึงพอใจให้ครบทุกข้อ
                                <v-icon class="ml-2" medium color="error">mdi-clipboard-alert</v-icon>
                            </v-card-title>
                            <v-card-actions>
                                <v-spacer></v-spacer>
